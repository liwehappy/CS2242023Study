...
def pad_sents(sents, pad_token):
    ...
    # 
    max_length = len(max(sents, key=lambda i: len(i)))
    for sublist in sents:
        sents_padded.append(sublist + [pad_token] * (max_length - len(sublist)))
    # sents_padded.append([sublist + [pad_token] * (max_length - len(sublist)) for sublist in sents])
